...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ORCommonUI-Swift/ORCommonUI_Swift.framework"
  install_framework "$BUILT_PRODUCTS_DIR/ORCropImageController/ORCropImageController.framework"
